...
public class TimeUtils {
     ...
     * 最大单位为月
     */
    private static final SimpleDateFormat mFormatterMonthToSecond =
            new SimpleDateFormat("HH/dd HH:ss", Locale.getDefault());
    ...
    private static long getDifferBetweenTime(long firstTime, long targetTime) {
        ...
        Log.d(TAG, "getDifferBetweenTime: 当前时间到目标时间的时间差：" + differTime);
        return differTime;
    }
